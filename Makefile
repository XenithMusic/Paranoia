...
OBJ_FILES = boot.o paranoia.o terminal.o string.o utils.o pit.o math.o memory.o fail.o idt.o idtroutine.o gdt.o isr.o isras.o syscall.o driver_ps2ctl.o driver_disk_ata.o driverman.o pic.o acpi.o page.o
